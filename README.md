...
**安装与日常使用请看：[安装使用说明.md](./安装使用说明.md)**（含三个 exe 路径、登录、开播流程、排障）。

## 架构

- **LiveAssistant.exe**（24小时直播助手） — 弹幕展示、点歌队列、音乐播放、自动回复
- **抖音 Sidecar** — `E:\我的源码目录\抖音网页弹幕\build\抖音直播弹幕助手.exe`（HTTP API，默认 `127.0.0.1:4723`）
